...
public class CompletableWithCompose {
	...
	public static void main(String[] args) {
		...
		try {
			...
			CompletableFuture future = future1.thenCombine(future2, (result1, result2) -> fuze(result1, result2))
					.thenApply(s -> s + ":: glue").thenCompose(s -> {
						...
						return future3.thenCombine(future4, (result3, result4) -> s + "::" + fuze(result3, result4));
					}).thenAccept(data -> {
